...
class userModels
{
    ...
    public function updateUser($pdo, $lastname, $firstname, $pseudo, $mail, $password, $campus, $promo, $github_link, $profile_picture, $anecdote)
    {
        $sql = "UPDATE 'users' SET ('lastname','firstname','pseudo','mail','password','campus','promo','github_link','profile_picture','anecdote') 
