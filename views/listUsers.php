<?php require('../controllers/listUserController.php'); ?>
            ...
            <div class="card border border-4 border-light m-3 p-0" style="width: 18rem;">
                ...
                <ul class="list-group list-group-flush">
                    <li class="list-group-item border border-light">
                        <small><span class="fw-bold">Campus :</span> Amiens</small>
                    </li>
                    <li class="list-group-item border border-light">
                        <small><span class="fw-bold">Période : </span>11/11/2021 à 12/12/2021</small>
                    </li>
                    <li class="list-group-item border border-light">
                        <small><span class="fw-bold">Promotion : </span>developpeur-php-p1</small>
                    </li>
                </ul>
                <div class="card-body">
